...
Descrição:
Computador escolhe número (Random 1..100). Usuário tenta adivinhar; diga maior/menor até acertar e conte tentativas.
...
class Program {
    static void Main() {
        ...
        Console.WriteLine("Exercício Jogo de adivinhação criado — edite este arquivo e implemente a lógica solicitada.");
    }
}
